...
Refinery::Resources.configure do |config|
  ...
  # config.dragonfly_secret = "02ef659fde4235b82f636f5a52c277d797ff3c1bf1cdec2b"
  # config.dragonfly_url_format = "/system/resources/:job/:basename.:format"
  # config.dragonfly_url_host = ""
  # config.datastore_root_path = "/Users/Phifo/Documents/projects/chivo/web/public/system/refinery/resources"
